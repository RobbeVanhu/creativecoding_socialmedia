...
$query="SELECT * FROM `socialmedia_images`, `socialmedia_users` WHERE users_username='$users_username' AND users_password='$users_password' AND image_users_ID=users_ID ";
